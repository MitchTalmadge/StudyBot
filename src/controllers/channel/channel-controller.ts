...
export abstract class ChannelController {
   ...
   */
  protected async purgeMessage(message: Discord.Message, delayMs: number = 0): Promise<void> {
    message.delete({
      timeout: delayMs,
   ...
   */
  protected async sendMessage(channel: Discord.TextChannel, content: string, options?: Discord.MessageOptions | Discord.MessageAdditions): Promise<Discord.Message> {
   ...
   */
  protected async sendTempMessage(lifeMs: number, channel: Discord.TextChannel, content: string, options?: Discord.MessageOptions | Discord.MessageAdditions): Promise<Discord.Message> {
